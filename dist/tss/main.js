...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.register = function (form) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.post(_config__WEBPACK_IMPORTED_MODULE_4__["cfg"].apiUrl + "/stripe/customers", {
                email: form.email,
                description: "TSS Customer Account for " + form.first_name + " " + form.last_name
            }).subscribe(function (data) {
                var customer = data['data'];
                form.customer_id = customer.id;
                _this.http.post(_config__WEBPACK_IMPORTED_MODULE_4__["cfg"].apiUrl + "/stripe/subscriptions", {
...
var LocationService = /** @class */ (function () {
    ...
    LocationService.prototype.getEventsByLocation = function (id) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.get(_config__WEBPACK_IMPORTED_MODULE_2__["cfg"].apiUrl + "/locations/" + id + "/events")
                .subscribe(function (data) {
                resolve(data);
            }, function (err) { return console.log(err); });
        });
...
var MemberService = /** @class */ (function () {
    ...
    MemberService.prototype.updateMember = function (form) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.patch(_config__WEBPACK_IMPORTED_MODULE_2__["cfg"].apiUrl + "/members", form)
                .subscribe(function (data) {
                resolve(data);
            }, function (err) { return console.log(err); });
        });
...
var cfg = {
    // API Url
    apiUrl: window.location.hostname == "localhost" ? "http://localhost:3100" : "https://solutetech.io",
...
var EventsComponent = /** @class */ (function () {
    function EventsComponent(event, modalService, formBuilder, location, toastr) {
        ...
        this.meridian = true;
        this.URL = _config__WEBPACK_IMPORTED_MODULE_7__["cfg"].apiUrl + "/upload";
    ...
    EventsComponent.prototype.onUpdate = function (id) {
        ...
        if (form.event_date)
            form.event_date = _config__WEBPACK_IMPORTED_MODULE_7__["cfg"].timeConverter(form.event_date);
        if (form.start_time)
            form.start_time = _config__WEBPACK_IMPORTED_MODULE_7__["cfg"].timeConverter(form.start_time);
        if (form.end_time)
            form.end_time = _config__WEBPACK_IMPORTED_MODULE_7__["cfg"].timeConverter(form.end_time);
...
module.exports = "<nav class=\"navbar navbar-expand-lg navbar-dark bg-dark\" *ngIf=\"isAuthenticated\">\n    <a class=\"navbar-brand\" href=\"#\">\n        <fa-icon [icon]=\"faHome\" size=\"lg\"></fa-icon>\n        {{ title }}\n    </a>\n\n    <button class=\"btn btn-outline-dark\" (click)=\"isMainCollapsed = !isMainCollapsed\" [attr.aria-expanded]=\"!isMainCollapsed\" aria-controls=\"main-menu\">\n        <span class=\"navbar-toggler-icon\"></span>\n    </button>\n    <button *ngIf=\"isAdmin\" class=\"btn btn-outline-light\" (click)=\"isAdminCollapsed = !isAdminCollapsed\" [attr.aria-expanded]=\"!isAdminCollapsed\" aria-controls=\"admin-menu\">\n        <fa-icon [icon]=\"faCog\" size=\"lg\"></fa-icon>\n    </button>\n</nav>\n\n<div id=\"main-menu\" [ngbCollapse]=\"!isMainCollapsed\">\n    <div class=\"dropdown-divider\"></div>\n    <button class=\"dropdown-item\" (click)=\"isMainCollapsed = !isMainCollapsed\" routerLink=\"/dashboard\">Dashboard</button>\n    <div class=\"dropdown-divider\"></div>\n    <button class=\"dropdown-item\" (click)=\"isMainCollapsed = !isMainCollapsed\" routerLink=\"/viewevents\">View Events</button>\n    <div class=\"dropdown-divider\"></div>\n    <button class=\"dropdown-item\" (click)=\"isMainCollapsed = !isMainCollapsed\" (click)=\"logout()\">Logout</button>\n</div>\n\n<div id=\"admin-menu\" [ngbCollapse]=\"!isAdminCollapsed\">\n    <button class=\"dropdown-item bg-dark text-white text-center\">Manage</button>\n    <button (click)=\"isAdminCollapsed = !isAdminCollapsed;\" class=\"dropdown-item\" routerLink=\"/ambassadors\">Ambassadors</button>\n    <!-- <div class=\"dropdown-divider\"></div> -->\n    <!-- <button (click)=\"isCollapsed = !isCollapsed\" class=\"dropdown-item\" routerLink=\"/attendees\">Attendees</button> -->\n    <div class=\"dropdown-divider\"></div>\n    <button (click)=\"isAdminCollapsed = !isAdminCollapsed;\" class=\"dropdown-item\" routerLink=\"/events\">Events</button>\n    <div class=\"dropdown-divider\"></div>\n    <button (click)=\"isAdminCollapsed = !isAdminCollapsed;\" class=\"dropdown-item\" routerLink=\"/locations\">Locations</button>\n    <div class=\"dropdown-divider\"></div>\n    <button (click)=\"isAdminCollapsed = !isAdminCollapsed;\" class=\"dropdown-item\" routerLink=\"/members\">Members</button>\n    <div class=\"dropdown-divider\"></div>\n    <button (click)=\"isAdminCollapsed = !isAdminCollapsed;\" class=\"dropdown-item\" routerLink=\"/memberships\">Memberships</button>\n    <div class=\"dropdown-divider\"></div>\n    <button (click)=\"isAdminCollapsed = !isAdminCollapsed;\" class=\"dropdown-item\" routerLink=\"/places\">Places</button>\n    <div class=\"dropdown-divider\"></div>\n    <button (click)=\"isAdminCollapsed = !isAdminCollapsed;\" class=\"dropdown-item\" routerLink=\"/surveys\">Surveys</button>\n    <div class=\"dropdown-divider\"></div>\n    <button (click)=\"isAdminCollapsed = !isAdminCollapsed;\" class=\"dropdown-item\" routerLink=\"/users\">Users</button>\n</div>"
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(user, location, auth, formBuilder, router, elementRef, toastr) {
        this.user = user;
        this.location = location;
        this.auth = auth;
        this.formBuilder = formBuilder;
...
module.exports = "<div class=\"container-fluid\">\n    <div class=\"row\">\n        <h3>List of Events</h3>\n    </div>\n\n    <div class=\"row listevents\">\n        <div class=\"col-sm-12 col-lg-3\" *ngFor=\"let event of events\">\n            <figure class=\"figure mt-3\">\n                <img [src]=\"event?.url\" [alt]=\"event?.name\" class=\"figure-img img-fluid rounded\" (click)=\"open(contentEvent, event)\" onerror=\"this.src='https://placeimg.com/640/480/people'\">\n                <figcaption class=\"figure-caption\">{{ event?.name }}</figcaption>\n            </figure>\n        </div>\n    </div>\n</div>\n\n<ng-template #contentEvent let-modal>\n    <div class=\"modal-header\">\n        <h4 class=\"modal-title mt-3 mb-4\">{{ viewevent?.name }}</h4>\n        <button type=\"button\" class=\"close\" aria-label=\"Close\" (click)=\"modal.close()\">\n            <span aria-hidden=\"true\">&times;</span>\n        </button>\n    </div>\n    <div class=\"modal-body\">\n        <img [src]=\"viewevent?.url\" [alt]=\"viewevent?.name\" onerror=\"this.src='https://placeimg.com/640/480/people'\">\n        <!-- <h4 class=\"mt-3\">{{ viewevent?.name }}</h4> -->\n        <div class=\"row pt-3\">\n            <div class=\"col start\"><strong><u>Event Date</u></strong><br/> <small>{{ viewevent?.event_date }}</small></div>\n            <div class=\"col center\"><strong><u>Event Times</u></strong><br/> <small>{{ viewevent?.start_time }} - {{ viewevent?.end_time }}</small></div>\n            <div class=\"col end\"><strong><u>Event Cost</u><br/></strong> <small>{{ viewevent?.cost | currency }}</small></div>\n        </div>\n        <div class=\"row\">\n            <div class=\"col pt-3\">\n                <strong><u>Event Description</u></strong>\n                <p [innerHTML]=\"viewevent?.description\"></p>\n            </div>\n        </div>\n        <div class=\"row\" *ngIf=\"payment\">\n            <h4>Payment</h4>\n            <form action=\"your-server-side-code\" method=\"POST\">\n                <script src=\"https://checkout.stripe.com/checkout.js\" class=\"stripe-button\" data-key=\"pk_test_c0Z0KtNcfkIVEiiKG3DKwgZr\" data-amount=\"999\" data-name=\"Fletch Lab\" data-description=\"Example charge\" data-image=\"https://stripe.com/img/documentation/checkout/marketplace.png\"\n                    data-locale=\"auto\">\n                </script>\n            </form>\n        </div>\n    </div>\n    <div class=\"modal-footer\">\n        <button *ngIf=\"membership != 11\" type=\"button\" class=\"btn btn-outline-dark btn-success\" (click)=\"rsvp(viewevent)\">RSVP</button>\n        <button *ngIf=\"membership == 11\" type=\"button\" class=\"btn btn-outline-success btn-success\" (click)=\"purchase(viewevent)\">Purchase a Ticket</button>\n        <!-- <button type=\"button\" class=\"btn btn-outline-success btn-success\" (click)=\"modal.close('Save click')\">Save</button> -->\n    </div>\n</ng-template>"
